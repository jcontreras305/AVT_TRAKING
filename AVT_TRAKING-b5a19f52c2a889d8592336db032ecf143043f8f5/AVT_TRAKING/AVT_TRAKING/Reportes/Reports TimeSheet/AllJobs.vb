...
Public Class AllJobs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AVT_TRAKING.AllJobs.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_excludeIdpo() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_exclude() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedAllJobs
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AllJobs = New AllJobs()
        rpt.Site = Me.Site
        Return rpt
    End Function
