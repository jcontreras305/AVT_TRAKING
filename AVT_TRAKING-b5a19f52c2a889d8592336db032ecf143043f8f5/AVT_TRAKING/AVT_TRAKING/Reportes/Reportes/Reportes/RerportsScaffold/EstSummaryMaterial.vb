...
Public Class EstSummaryMaterial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AVT_TRAKING.EstSummaryMaterial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstSummaryMaterial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EstSummaryMaterial = New EstSummaryMaterial()
        rpt.Site = Me.Site
        Return rpt
    End Function
