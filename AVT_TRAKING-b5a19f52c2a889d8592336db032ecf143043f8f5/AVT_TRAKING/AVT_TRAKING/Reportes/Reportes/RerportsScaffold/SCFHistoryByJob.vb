...
Public Class SCFHistoryByJob
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AVT_TRAKING.SCFHistoryByJob.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSCFHistoryByJob
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SCFHistoryByJob = New SCFHistoryByJob()
        rpt.Site = Me.Site
        Return rpt
    End Function
