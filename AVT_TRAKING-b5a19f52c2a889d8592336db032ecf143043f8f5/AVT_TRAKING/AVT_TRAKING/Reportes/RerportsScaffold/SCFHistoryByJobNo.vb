...
Public Class SCFHistoryByJobNo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AVT_TRAKING.SCFHistoryByJobNo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSCFHistoryByJobNo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SCFHistoryByJobNo = New SCFHistoryByJobNo()
        rpt.Site = Me.Site
        Return rpt
    End Function
