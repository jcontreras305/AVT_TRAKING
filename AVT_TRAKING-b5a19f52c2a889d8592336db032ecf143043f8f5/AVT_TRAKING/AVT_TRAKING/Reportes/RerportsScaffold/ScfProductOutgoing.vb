...
Public Class ScfProductOutgoing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AVT_TRAKING.ScfProductOutgoing.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ticket() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedScfProductOutgoing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ScfProductOutgoing = New ScfProductOutgoing()
        rpt.Site = Me.Site
        Return rpt
    End Function
