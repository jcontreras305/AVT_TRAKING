...
begin 
	update pipingEst set idPipingEst = " + row.ItemArray(1).ToString() + ",line='" + row.ItemArray(2).ToString() + "',size=" + row.ItemArray(3).ToString() + ",[type]=" + If(row.ItemArray(4) = "", "NULL", "'" + row.ItemArray(4).ToString() + "'") + ",thick = " + If(row.ItemArray(5) = "", "0", row.ItemArray(5).ToString()) + " ,systemPntPP=" + If(row.ItemArray(6) = "", "NULL", "'" + row.ItemArray(6).ToString() + "'") + ",pntOption=" + If(row.ItemArray(7) = "", "NULL", "'" + row.ItemArray(7).ToString() + "'") + ",idJacket=" + If(row.ItemArray(8) = "", "NULL", "'" + row.ItemArray(8).ToString() + "'") + ",elevation=" + row.ItemArray(9).ToString() + ",idLaborRateRmv=" + If(row.ItemArray(10) = "", "NULL", "'" + row.ItemArray(10).ToString().ToString.Replace("'", "''") + "'") + ",lFtRmv=" + row.ItemArray(11).ToString() + ",idLaborRatePnt=" + If(row.ItemArray(12) = "", "NULL", "'" + row.ItemArray(12).ToString().ToString.Replace("'", "''") + "'") + ",
    lFtPnt=" + row.ItemArray(13).ToString() + ",p90Pnt=" + row.ItemArray(14).ToString() + ",p45Pnt=" + row.ItemArray(15).ToString() + ",pTeePnt=" + row.ItemArray(16).ToString() + ",pPairPnt=" + row.ItemArray(17).ToString() + ",pVlvPnt=" + row.ItemArray(18).ToString() + ",pControlPnt=" + row.ItemArray(19).ToString() + ",pWeldPnt=" + row.ItemArray(20).ToString() + ",idLaborRateII=" + If(row.ItemArray(21) = "", "NULL", "'" + row.ItemArray(21).ToString().ToString.Replace("'", "''") + "'") + ",lFtII=" + row.ItemArray(22).ToString() + ",p90II=" + row.ItemArray(23).ToString() + ",p45II=" + row.ItemArray(24).ToString() + ",pBendII=" + row.ItemArray(25).ToString() + ",pTeeII=" + row.ItemArray(26).ToString() + ",pReducII=" + row.ItemArray(27).ToString() + ",pCapsII=" + row.ItemArray(28).ToString() + ",pPairII=" + row.ItemArray(29).ToString() + ",pVlvII=" + row.ItemArray(30).ToString() + ",pControlII=" + row.ItemArray(31).ToString() + ",pWeldII=" + row.ItemArray(32).ToString() + ",pCutOutII=" + row.ItemArray(33).ToString() + ",psupportII=" + row.ItemArray(34).ToString() + ",acm=" + row.ItemArray(35).ToString() + ",st=" + row.ItemArray(35).ToString() + " where idPipingEst = " + row.ItemArray(0).ToString() + " and idDrawingNum = '" + If(lastIdDrawing <> "", lastIdDrawing, idDrawing) + "' 
end"
                    End If
                    cmbTags.Connection = conn
                    cmbTags.Transaction = tran
