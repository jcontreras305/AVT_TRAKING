...
Public Class ReportByJobNo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AVT_TRAKING.ReportByJobNo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportByJobNo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportByJobNo = New ReportByJobNo()
        rpt.Site = Me.Site
        Return rpt
    End Function
