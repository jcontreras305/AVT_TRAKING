...
Public Class SCFRentalDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AVT_TRAKING.SCFRentalDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSCFRentalDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SCFRentalDetails = New SCFRentalDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
