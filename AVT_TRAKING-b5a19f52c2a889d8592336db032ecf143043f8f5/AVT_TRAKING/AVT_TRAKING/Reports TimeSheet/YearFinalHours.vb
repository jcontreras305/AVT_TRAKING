...
Public Class YearFinalHours
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AVT_TRAKING.YearFinalHours.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedYearFinalHours
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As YearFinalHours = New YearFinalHours()
        rpt.Site = Me.Site
        Return rpt
    End Function
