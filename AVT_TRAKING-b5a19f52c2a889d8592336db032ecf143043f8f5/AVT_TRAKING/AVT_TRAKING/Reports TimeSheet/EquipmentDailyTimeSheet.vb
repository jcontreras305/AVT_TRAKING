...
Public Class EquipmentDailyTimeSheet
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "EquipmentDailyTimeSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AVT_TRAKING.EquipmentDailyTimeSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEquipmentDailyTimeSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EquipmentDailyTimeSheet = New EquipmentDailyTimeSheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
