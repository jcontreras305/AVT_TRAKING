...
Public Class MaterialReportByPO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AVT_TRAKING.MaterialReportByPO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMaterialReportByPO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MaterialReportByPO = New MaterialReportByPO()
        rpt.Site = Me.Site
        Return rpt
    End Function
