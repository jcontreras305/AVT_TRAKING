...
Public Class Vacation_Employee
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AVT_TRAKING.Vacation_Employee.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NoEmployee() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedVacation_Employee
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Vacation_Employee = New Vacation_Employee()
        rpt.Site = Me.Site
        Return rpt
    End Function
