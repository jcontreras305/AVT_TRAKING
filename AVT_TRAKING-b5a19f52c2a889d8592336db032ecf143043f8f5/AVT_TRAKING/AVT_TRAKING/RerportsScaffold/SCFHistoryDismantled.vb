...
Public Class SCFHistoryDismantled
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SCFHistoryDismantled.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AVT_TRAKING.SCFHistoryDismantled.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSCFHistoryDismantled
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SCFHistoryDismantled = New SCFHistoryDismantled()
        rpt.Site = Me.Site
        Return rpt
    End Function
