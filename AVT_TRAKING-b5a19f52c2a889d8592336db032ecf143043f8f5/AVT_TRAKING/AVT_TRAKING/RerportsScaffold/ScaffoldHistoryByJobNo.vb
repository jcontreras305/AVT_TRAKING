...
Public Class ScaffoldHistoryByJobNo
    Private Sub ScaffolHistoryByJobNo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnReport_Click(sender As Object, e As EventArgs) Handles btnReport.Click
        Try
            ...
            If clNum <> "" Or clNum IsNot Nothing Then
                Dim reportTs As New SCFHistoryByJobNo
