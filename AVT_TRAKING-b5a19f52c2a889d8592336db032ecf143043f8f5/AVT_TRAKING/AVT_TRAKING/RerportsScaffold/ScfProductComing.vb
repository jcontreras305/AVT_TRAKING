...
Public Class ScfProductComing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AVT_TRAKING.ScfProductComing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedScfProductComing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ScfProductComing = New ScfProductComing()
        rpt.Site = Me.Site
        Return rpt
    End Function
